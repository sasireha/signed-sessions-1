...
AesCryptoConfig contains the key used for encryting the data. The key is a Hex value.
...
AesCryptoConfig:
  AesEncryptionKey: "Hex value (256 bit (=32 byte) AES key)"
```